<template>
  <el-main class="no-padding">
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item v-if="activeName === '0'">采集协议 ({{sub_device_name}})</el-breadcrumb-item>
      <el-breadcrumb-item v-else-if="activeName === '1'">特征提取 ({{sub_device_name}})</el-breadcrumb-item>
      <el-breadcrumb-item v-else-if="activeName === '2'">数据转发 ({{sub_device_name}})</el-breadcrumb-item>
      <el-breadcrumb-item v-else-if="activeName === '3'">设备动态 ({{sub_device_name}})</el-breadcrumb-item>
    ...
    <el-row class="row-padding-top">
      <el-tabs v-model="activeName" type="border-card"  >
        <el-tab-pane v-if="title !== '智能设备列表'" label="采集协议" :disabled="enable" name= '0' style="overflow-y:auto;overflow-x:hidden;">
            <acquisition-protocol v-if="activeName === '0'" @dump="dump"></acquisition-protocol>
        </el-tab-pane>
        ...
        <el-tab-pane label="设备动态" name= '3' style="overflow-y:auto;overflow-x:hidden;">
          <device-log v-if="activeName ==='3'" ></device-log>
        </el-tab-pane>
        <!-- <el-tab-pane label="状态分析" name= '3' style="overflow-y:auto;overflow-x:hidden;">
          <device-status v-if="activeName ==='3'" ></device-status>
        </el-tab-pane> -->
      </el-tabs>
    </el-row>
    <!-- 显示的页面 -->
...
export default {
  data () {
    return {
      ...
      // sub_device_name: this.$route.query.sub_device_name,
    }
  },
  created () {
