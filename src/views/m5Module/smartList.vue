<template>
  <el-main class="no-padding">
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>智能设备列表</el-breadcrumb-item>
    </el-breadcrumb>
    <div class="smartrow">
...
export default {
  ...
  methods: {
    ...
    getRowInfo (index, subdevice) {
      ...
      window.sessionStorage.setItem('subdevice', JSON.stringify(subdevice))
      this.$router.push({ path: 'deviceManage', query: { subdevice: index } })
    }
