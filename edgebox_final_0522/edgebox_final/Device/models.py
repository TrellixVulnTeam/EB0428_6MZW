...
# 设备模板库  Canis pro的库
class EquipmentTemplateCanis(BaseModel):
    '''
    专有协议 设备模板库 表 简称 etc
    '''
    FORMAT_CHOICES = (
    ...
    etc_accordname  = models.CharField(max_length=30, default="专有协议接口Canis", verbose_name="模板协议名称")
    etc_pip_no      = models.SmallIntegerField(default=0, choices=PIPNO, verbose_name="Canis通道")
    etc_col         = models.CharField(max_length=30, verbose_name="列名")
    etc_format      = models.SmallIntegerField(default=0, choices=FORMAT_CHOICES, verbose_name="模板数据格式")
    etc_round       = models.CharField(max_length=30, verbose_name="模板返回数据精确值")
...
class applyTemplateCanisInterface(BaseModel):
    '''
    应用Tcp设备模板接口信息
    '''
...
class applyTemplateMQTTInterface(BaseModel):
    '''
    应用Tcp设备模板接口信息
    '''
