...
urlpatterns = [
    ...
    url(r'^template/delete/', views.templateDelete, name='templatedelete'),  #
    url(r'^template/create/', views.templateCreate, name='templatecreate'),  #
    url(r'^template/update/', views.templateUpdate, name='templateupdate'),  #
    # url(r'^template/select/', views.templateUpdate, name='templateupdate'),  #
    url(r'^modbusrtuform/', views.modbusRtuForm, name='modbusrtufrom'),  #
    url(r'^modbustcpform/', views.modbusTcpForm, name='modbustcpform'),  #
    url(r'^canisproform/', views.canisproForm, name='canisproform'),  #
    url(r'^mqttform/', views.mqttForm, name='mqttform'),  #
    url(r'^template/apply/', views.templateApply, name='templateapply'),  #
    url(r'^apply$', views.showApply, name='showapply'),  #
    # url(r'^plot$', views.plot, name='plot'),  #
    url(r'^status_img$', views.device_status, name='img'),  #
    url(r'^data$', views.Data, name='data'),  #
    url(r'^filedata/', views.fileData, name='filedata'),  #
    url(r'^dbdata/', views.dbData, name='dbdata'),  #
