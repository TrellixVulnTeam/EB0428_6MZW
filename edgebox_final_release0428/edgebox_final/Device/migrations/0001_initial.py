    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('etc_accordname', models.CharField(default='专有协议接口Canis', max_length=30, verbose_name='模板协议名称')),
                ('etc_pip_no', models.SmallIntegerField(choices=[(0, '通道1'), (1, '通道2'), (2, '通道3'), (3, '通道4'), (4, '通道5'), (5, '通道6')], default=0, verbose_name='Canis通道')),
                ('etc_col', models.CharField(max_length=30, verbose_name='列名')),
                ('etc_format', models.SmallIntegerField(choices=[(0, '电压值')], default=0, verbose_name='模板数据格式')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('etr_format', models.SmallIntegerField(choices=[(0, '2进制输出'), (1, '10进制输出'), (2, '16进制输出'), (3, 'IEEE-754输出'), (4, 'DATA-2301输出'), (5, '浮点型输出')], default=0, verbose_name='模板返回设备数据格式')),
