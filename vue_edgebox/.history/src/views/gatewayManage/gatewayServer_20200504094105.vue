  ...
  <el-main class="no-padding">
    ...
    <el-tabs v-model="activeName" type="border-card" class="tabs-margin-top">
      ...
      <el-tab-pane label="恢复出厂设置" name="second">
        ...
        <!-- 配置mqtt弹出框 -->
    <!-- <el-dialog title="配置mqtt" :visible.sync="configmqttDialog" custom-class="mqtt-config-box dialog-form"  width="560px">
      <el-form :model="mqttForm" label-position="left" label-width="100px" :rules="modifyrules" ref="mqttForm">
        
        <el-form-item label="Host:" prop="name">
          <el-input type="text" size="small" oninput="value=value.replace(/[^0-9^A-Z^a-z]/g, '')" v-model="mqttForm.name" disabled></el-input>
        </el-form-item>
        <el-form-item label="Port:" prop="model">
          <el-input type="text" size="small" v-model="mqttForm.model"></el-input>
        </el-form-item>
        <el-form-item label="Username:" prop="position">
          <el-input type="text" size="small" v-model="mqttForm.position"></el-input>
        </el-form-item>       
      ...
      <el-row  slot="footer">
        <el-button type="default" size="small" @click="ConfigMqtt=false">取消</el-button>
        <el-button type="primary" size="small" @click="ConfMqtt('mqttForm')">确定</el-button>
      </el-row>
    </el-dialog> -->
