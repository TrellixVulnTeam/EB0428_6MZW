    ...
    <el-tabs v-model="activeName" type="border-card" class="tabs-margin-top">
      ...
      <el-tab-pane label="恢复出厂设置" name="second">
        ...
        <!-- <el-tabs v-model="activeName1" type="border-card" class="tabs-margin-top">
          ...
          <el-button type="danger" @click="configmqttDialog=true">配置MQTT</el-button>
      </el-tab-pane>
    </el-tabs>
    ...
    <el-dialog title="配置mqtt" :visible.sync="configmqttDialog" custom-class="chile-device-box dialog-form"  width="560px">
      <el-form :model="mqttForm" label-position="left" label-width="100px">
        ...
        <el-form-item label="Host:" prop="host">
          <el-input type="text" size="small" v-model="mqttForm.host" placeholder="mqtt host :case 127.0.0.1"></el-input>
        </el-form-item>
        <el-form-item label="Port:" prop="port">
          <el-input type="text" size="small" v-model="mqttForm.port" placeholder="mqtt post :case 1883"></el-input>
        </el-form-item>
