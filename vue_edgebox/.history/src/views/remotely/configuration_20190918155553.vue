    ...
    <el-table :data="tableData">
      ...
      <el-table-column label="MQTT的Topic">
        <template v-slot="scope">
          <span ref="copy">{{scope.row.topic}}</span>&nbsp;
          <el-button type="text" class="el-icon-document" @click="copy()" @copy="paste($event)"></el-button>
        </template>
      </el-table-column>
...
export default {
  ...
  methods: {
    ...
    paste(e) {
      e.preventDefault();
      e.clipboardData.setData("text/plain", this.$refs[copy].textContent);
