  ...
  <el-main class="no-padding">
    ...
    <el-drawer
      ...
      <el-table style="padding-left:20px" :data="tableData">
        <el-table-column label="功能" prop="tableData.down_type" min-width="25%"></el-table-column>
        <el-table-column label="主題" prop="tableData.down_topic" min-width="60%"></el-table-column>
      </el-table>
