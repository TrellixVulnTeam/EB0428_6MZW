<template>
  <el-main class="no-padding">
    ...
    <el-tooltip :content="'Switch value: ' + is_active" placement="top">
      <el-switch
        v-model="is_active"
    ...
    <el-table :data="tableData" v-loading="loading" windh="100%">
      ...
      <el-table-column sortable label="调用" prop="down_num" min-width="7%">
      ...
      this.$axios.post("apis/remotely/setting/enable/", {
        ...
        .then(response => {
          if(response.data.status_code==1){
            this.$Message.ErrorMessage(_this, response.data.message);
          }
          else{
