  ...
  <el-main class="no-padding smartremote">
    ...
    <el-table :data="tableData"  ref="refTable" >
      ...
      <template slot-scope="scope">
        ...
        <el-table-column label="通信组名称" prop="smart_name" min-width="35%"></el-table-column>
        <el-table-column sortable label="应用区域" prop="smart_area" min-width="35%">
          <template slot-scope="scope">
        ...
        <el-table-column label="消息详情" prop="smart_remark" min-width="40%"></el-table-column>
    ...
    <el-dialog
      ...
      <el-form :data="tableData" :rules="rules" ref="form" :model="form" label-position="left" label-width="100px">
        <el-form-item label="通信组名称" prop="name">
          <el-input v-model="form.name" size="small"></el-input>
        </el-form-item>
        <el-form-item label="应用区域" prop="region">
          <el-select size="small" v-model="form.region" placeholder="请选择应用区域">
    ...
    <el-dialog
      ...
      <el-form :data="tableData" :rules="rules" ref="form" :model="form2" label-position="left" label-width="100px">
        ...
        <el-form-item label="指令" prop="order">
          <el-input type="textarea" rows="3" v-model="form2.order"></el-input>
        </el-form-item>
      <div>示例：    {"Command":"1","cRed":"off","cYellow":"off","cGreen":"on"}</div>
      </el-form>
      <el-row  slot="footer">
