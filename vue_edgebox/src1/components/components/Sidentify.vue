<template>
    <div class="s-canvas" style="line-height:0px">
    ...
    export default {
        ...
        methods: {
            ...
            drawPic() {
                ...
                this.identifyCode = this.randomSidentify(4,"0123456789abcdefghijkmnlopqrstuvwxyz")
            ...
            drawText(ctx, txt, i) {
                ...
                let y = this.randomNum(this.fontSizeMax-10, this.contentHeight - 5)
