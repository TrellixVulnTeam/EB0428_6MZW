...
<template>
    <div >
     <el-tabs v-model="activeName" :tab-position="tabPosition" @tab-click="handleClick" style="height: 50%; width:100%">
        ...
        <el-tab-pane label="Plot" name="Plot">
            ...
            <div ref="plot" style="width: 750px; height: 300px"></div>
        </el-tab-pane>
     </el-tabs>
      <el-row  slot="footer">
...
export default {
    ...
    methods: {
      ...
      echart() {
        this.Myechart = this.$echarts.init(this.$refs.plot); // 获取dom节点
        ...
        let option_line = {
            ...
            this.Myechart.setOption(option_line);
         },
        }
    }
</script>
