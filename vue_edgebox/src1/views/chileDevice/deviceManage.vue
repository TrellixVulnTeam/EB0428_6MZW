<template>
  <el-main class="no-padding">
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item v-else-if="activeName === '3'">设备动态 ({{subdevice_name}})</el-breadcrumb-item>
      <el-breadcrumb-item v-else-if="activeName === '4'">模型預測 ({{subdevice_name}})</el-breadcrumb-item>
    ...
    <el-row class="row-padding-top">
      <el-tabs v-model="activeName" type="border-card"  >
        ...
        <el-tab-pane label="模型預測" name= '4' style="overflow-y:auto;overflow-x:hidden;">
          <model-predict v-if="activeName ==='4'" ></model-predict>
        </el-tab-pane>
