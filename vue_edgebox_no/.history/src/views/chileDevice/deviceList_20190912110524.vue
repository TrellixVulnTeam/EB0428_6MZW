<template>
  <el-main class="no-padding">
    ...
    >
      ...
      <el-table-column label="名称">
        <template v-slot="scope">
          <el-button type="text" size="small" @click="getRowInfo(scope.row)">{{scope.row.name}}</el-button>
        </template>
      </el-table-column>
      ...
      <el-table-column label="操作">
        <template v-slot="scope">
          <el-button type="text" size="small" @click="modifyFormInfo(scope.row)">修改</el-button>
    ...
    <!-- 修改设备信息弹出框 -->
    <el-dialog title="修改子设备信息" :visible.sync="modifyDialog" custom-class="chile-device-box dialog-form">
      <el-form :model="modifyForm" label-position="left" label-width="100px" :rules="modifyRules" ref="modifyForm">
        <el-form-item label="设备名称:" prop="name">
          <el-input type="text" size="small" v-model="modifyForm.name"></el-input>
        </el-form-item>
        <el-form-item label="所属类别:" prop="typeSelect">
