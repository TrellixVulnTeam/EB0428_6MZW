    ...
    <el-dialog title="配置mqtt" :visible.sync="configmqttDialog" custom-class="mqtt-config-box dialog-form"  width="560px">
      <el-form :model="mqttForm" label-position="left" label-width="100px">
        ...
        <el-form-item label="Host:" prop="host">
          <el-input type="text" size="small" v-model="mqttForm.host"></el-input>
        </el-form-item>
        <el-form-item label="Port:" prop="port">
          <el-input type="text" size="small" v-model="mqttForm.port"></el-input>
        </el-form-item>
        <el-form-item label="Username:" >
          <el-input type="text" size="small" v-model="mqttForm.username"></el-input>
        </el-form-item>       
        <el-form-item label="Password:" >
          <el-input type="text" size="small" v-model="mqttForm.password"></el-input>
        </el-form-item>
