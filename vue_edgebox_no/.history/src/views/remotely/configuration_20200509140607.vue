  ...
  <el-main class="no-padding">
    ...
    <el-table :data="tableData" v-loading="loading" windh="100%">
      ...
      <el-table-column label="操作" min-width="10%">
        <template v-slot="scope">
          <el-button type="text" size="small" @click="openDraw(scope.row, scope.row.down_topic,scope.row.down_type)">使用说明</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-drawer
      ...
      <el-table style="padding-left:20px" :data="tableData">
      ...
      <!-- <pre style="position:relative;left:5%;width: 90%;border: 1px solid #ccc;text-align: left;outline: none">
        {
          <span style="color:#111111">"status_code":</span> <span style="color:#009933">200/400 ,</span>
          <span style="color:#111111">"message":</span> <span style="color:#009933">Success/Fail</span>
        }
      </pre> -->
...
export default {
  ...
  methods: {
    getData() {
      ...
      .then(response => {
        this.tableDataa = response.data.db
    ...
    openDraw(row, topic, type){
    
      this.tableData[0].topic = topic
      this.tableData[0].type = type
      this.table_data = [row]
      this.drawer = true
      console.log(row)
    },
