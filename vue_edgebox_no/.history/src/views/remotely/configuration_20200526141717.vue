  ...
  <el-main class="no-padding">
    ...
    <!-- <span v-if="is_active==false">
      <el-tooltip content="开启配置下发" placement="top">
        <el-button type="success" size="small" @click="is_active=true" style="color:red">开启配置下发</el-button>
      </el-tooltip>

    </span>
    <span v-else>
      <el-tooltip content="关闭配置下发" placement="top">
        <el-button type="success" size="small" @click="is_active=false">关闭配置下发</el-button>
      </el-tooltip>
    ...
    <el-table :data="tableData" v-loading="loading" windh="100%">
      ...
      <el-table-column label="Topic主题"  min-width="45%">
      ...
      <el-table-column sortable label="成功" prop="down_num" min-width="10%">
          <template slot-scope="scope">
            <el-tag size="medium" style="border-bottom: solid;">{{ scope.row.down_num }}</el-tag>
          </template>
      </el-table-column>
      <el-table-column sortable label="失败" prop="down_num2" min-width="10%">
          <template slot-scope="scope">
            <el-tag size="medium" type="warning" style="border-bottom: solid;">{{ scope.row.down_num2 }}</el-tag>
          </template>
      </el-table-column>
      <el-table-column label="描述" prop="down_remark"  min-width="20%"></el-table-column>
