    ...
    <el-table :data="tableData">
      ...
      <el-table-column label="MQTT的Topic">
        <template v-slot="scope">
          <span ref="copy" @click="paste($event, this)">{{scope.row.topic}}</span>&nbsp;
          <el-button type="text" class="el-icon-document" @click="paste($event, this)"></el-button>
        </template>
      </el-table-column>
...
export default {
  ...
  methods: {
    ...
    paste(e, self) {
      e.preventDefault();
      console.log(e);
      e.clipboardData.setData("text/plain", self.innerText);
