<template>
  <el-main class="no-padding smartremote">
    ...
    <el-table :data="tableData"  ref="refTable" @row-click="clickTable">
        <el-table-column label="下发类型" prop="name" min-width="60%"></el-table-column>
        <el-table-column sortable label="下发主题" prop="protocol">
        ...
        <el-table-column label="操作" min-width="60%">
            <template slot-scope="scope">
                <el-button type="text" size="small" style="color: #08bba2" @click="show(scope.row)">配置</el-button>
                <el-button type="text" size="small" style="color: #FF0000" @click="deleteRow(scope.row.name)">下发</el-button>
            </template>
        </el-table-column>
