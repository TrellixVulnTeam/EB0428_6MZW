  ...
  routes: [
    {
      path: '/upFile',
      name: 'upFile',
      component: () => import(/* webpackChunkName: "about" */ '../fileTest/uploadFile.vue'),
      meta:{
        needLogin:false,
        title:'上传文件'
      },
    },
    {
      path: '/phone',
      name: 'phone',
      component: () => import(/* webpackChunkName: "about" */ '../views/phone/listChart.vue'),
      meta:{
        needLogin:false,
        title:'手机适配'
      },
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          path: '/smartRemote',
          name: 'smartRemote',
          component: () => import(/* webpackChunkName: "about" */ '../views/m5Module/smartRemote.vue')
        },
        {
          path: '/Login',
          name: 'Login',
