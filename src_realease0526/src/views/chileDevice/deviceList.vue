<template>
  <el-main class="no-padding">
    ...
    >
      ...
      <el-table-column  width="130" label="类型" prop="subdevice_type"></el-table-column>
      <el-table-column  width="120" label="型号" prop="subdevice_model"></el-table-column>
      <el-table-column label="位置" prop="subdevice_position" width="120px"></el-table-column>
      <!-- <el-table-column label="描述" prop="subdevice_remark"></el-table-column> -->
      <el-table-column label="最近上线时间" prop="subdevice_online_time" width='160px'></el-table-column>
      <el-table-column label="启用/禁用" width="90px">
        <template v-slot="scope">
      ...
      <el-table-column label="状态" prop="subdevice_status" width="150px">
      ...
      <el-table-column label="操作">
        <template v-slot="scope">
          ...
          <el-button type="text" style="color: #FF0000" @click="deleteRow">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    </div>
    ...
    <el-dialog title="添加子设备" :visible.sync="dialogFormVisible" custom-class="chile-device-box dialog-form" width="560px">
      <el-form :model="form" label-position="left" label-width="100px" :rules="rules" ref="form">
        ...
        <el-form-item label="设备描述:" >
          <el-input type="text" rows="3" v-model="form.description" placeholder="sbdevice remark :case 这是一个惠测单相电表"></el-input>
        </el-form-item>
      </el-form>
      <el-row  slot="footer">
    ...
    <el-dialog title="修改子设备信息" :visible.sync="modifyDialog" custom-class="chile-device-box dialog-form"  width="560px">
      <el-form :model="modifyForm" label-position="left" label-width="100px" :rules="rules" ref="modifyForm">
        <el-form-item label="所属类别:" prop="typeSelect">
        ...
        <el-form-item label="设备名称:" prop="name">
          <el-input type="text" size="small" oninput="value=value.replace(/[^0-9^A-Z^a-z]/g, '')" v-model="modifyForm.name"></el-input>
        </el-form-item>
        <el-form-item label="设备型号:" prop="model">
        ...
        <el-form-item label="设备描述:" >
          <el-input type="text" rows="3" v-model="modifyForm.description"></el-input>
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    getRowInfo (row) {
      ...
      this.$router.push({ path: 'deviceManage', query: { subdevice: row } })
    },
