<template>
  <el-main class="no-padding">
    ...
    <el-table :data="tableData">
      ...
      <el-table-column width="180px" label="路径名称" prop="addressName"></el-table-column>
      ...
      <el-table-column  width="130" label="启用 / 禁用" prop="switch">
      ...
      <el-table-column width="130" label="上行消息数" prop="mesNumber"></el-table-column>
        ...
        <div v-else-if="form.type==='CorePro Server'">
         ...
         <el-form-item label="数据类型:" prop="datatype">
          ...
          <el-form-item label="消息主题:" prop="datatopic">
            <el-input type="text" v-model="form.datatopic" size="small" placeholder="CorePro 基础版的消息ID"></el-input>
          </el-form-item>
        </div>
        <template v-else-if="form.type==='DB'">
          <el-form-item label="库类型:" prop="DB_type">
            <el-select v-model="form.DB_type" size="small" style="width: 100%" placeholder="请选择数据库类型">
              <el-option v-for="(item,index) in form.DB_baseType" :key="index" :value="item" :label="item"></el-option>
            </el-select>
          </el-form-item>
          <el-form-item label="主机名:" prop="DB_hostName">
            <el-input type="text" v-model="form.DB_hostName" size="small" placeholder="请输入主机IP"></el-input>
          </el-form-item>
          <el-form-item label="端口:" prop="DB_port">
            <el-input type="text" v-model="form.DB_port" size="small" placeholder="请输入主机IP"></el-input>
          </el-form-item>
          <el-form-item label="用户名:" prop="DB_userName">
            <el-input type="text" v-model="form.DB_userName" size="small" placeholder="请输入主机IP"></el-input>
          </el-form-item>
          <el-form-item label="密码:" prop="DB_passWord">
            <el-input type="text" v-model="form.DB_passWord" size="small" placeholder="请输入主机IP"></el-input>
          </el-form-item>
          <el-form-item label="库名称:" prop="DB_baseName">
            <el-input type="text" v-model="form.DB_baseName" size="small" placeholder="请输入主机IP"></el-input>
          </el-form-item>
        </template>
        <template v-else-if="form.type==='FTP'">
          <el-form-item label="主机名:" prop="FTP_hostName">
            <el-input type="text" v-model="form.FTP_hostName" size="small" placeholder="请输入主机IP"></el-input>
          </el-form-item>
          <el-form-item label="端口:" prop="FTP_port">
            <el-input type="text" v-model="form.FTP_port" size="small" placeholder="请输入主机IP"></el-input>
          </el-form-item>
          <el-form-item label="用户名:" prop="FTP_userName">
            <el-input type="text" v-model="form.FTP_userName" size="small" placeholder="请输入主机IP"></el-input>
          </el-form-item>
          <el-form-item label="密码:" prop="FTP_passWord">
            <el-input type="text" v-model="form.FTP_passWord" size="small" placeholder="请输入主机IP"></el-input>
          </el-form-item>
          <el-form-item label="远程目录:" prop="FTP_remote">
            <el-input type="text" v-model="form.FTP_remote" size="small" placeholder="请输入主机IP"></el-input>
          </el-form-item>
        </template>
        <template v-else-if="form.type==='SFTP'">
          <el-form-item label="主机名:" prop="SFTP_hostName">
            <el-input type="text" v-model="form.SFTP_hostName" size="small" placeholder="请输入主机IP"></el-input>
          </el-form-item>
          <el-form-item label="端口:" prop="SFTP_port">
            <el-input type="text" v-model="form.SFTP_port" size="small" placeholder="请输入主机IP"></el-input>
          </el-form-item>
          <el-form-item label="用户名:" prop="SFTP_userName">
            <el-input type="text" v-model="form.SFTP_userName" size="small" placeholder="请输入主机IP"></el-input>
          </el-form-item>
          <el-form-item label="密码:" prop="SFTP_passWord">
            <el-input type="text" v-model="form.SFTP_passWord" size="small" placeholder="请输入主机IP"></el-input>
          </el-form-item>
          <el-form-item label="远程目录:" prop="SFTP_remote">
            <el-input type="text" v-model="form.SFTP_remote" size="small" placeholder="请输入主机IP"></el-input>
          </el-form-item>
        </template>
      </el-form>
      <el-row  slot="footer">
        <el-button  v-if="form.type !== 'CorePro Server' && form.type !== ''" type="success" size="small" @click="test('form')" >测试</el-button>
  ...
  data () {
    ...
    return {
      ...
      rules: { // 新增转发表单验证
        ...
        DB_type: [{ required: true, validator: checkNull, trigger: 'change' }],
        DB_baseName: [{ required: true, validator: checkNull, trigger: 'blur' }],
        DB_hostName: [{ required: true, validator: checkNull, trigger: 'blur' }],
        DB_userName: [{ required: true, validator: checkNull, trigger: 'blur' }],
        DB_passWord: [{ required: true, validator: checkNull, trigger: 'blur' }],
        DB_port: [{ required: true, validator: checkNull, trigger: 'blur' }],
        FTP_hostName: [{ required: true, validator: checkNull, trigger: 'blur' }],
        FTP_port: [{ required: true, validator: checkNull, trigger: 'blur' }],
        FTP_userName: [{ required: true, validator: checkNull, trigger: 'blur' }],
        FTP_passWord: [{ required: true, validator: checkNull, trigger: 'blur' }],
        FTP_remote: [{ required: true, validator: checkNull, trigger: 'blur' }],
        SFTP_hostName: [{ required: true, validator: checkNull, trigger: 'blur' }],
        SFTP_port: [{ required: true, validator: checkNull, trigger: 'blur' }],
        SFTP_userName: [{ required: true, validator: checkNull, trigger: 'blur' }],
        SFTP_passWord: [{ required: true, validator: checkNull, trigger: 'blur' }],
        SFTP_remote: [{ required: true, validator: checkNull, trigger: 'blur' }],
      },
      typeList: [
  ...
  methods: {
    ...
    getData () {
      ...
      this.$axios.get('apis/agent/info/')
        .then(response => {
          this.agent.gateway_name = response.data.gateway_name
          this.agent.gateway_id = response.data.gateway_key
          this.agent.gateway_location = response.data.gateway_location

          this.form.pubtopic = response.data.gateway_name.toLowerCase() + '/' + this.subdevice_name.toLowerCase() + '/'
          this.form.datatopic = '/data/' + response.data.gateway_key + '/' + '{数据类型}/data/gateway'
        })
    },
    save (formName) {
      var _this = this
