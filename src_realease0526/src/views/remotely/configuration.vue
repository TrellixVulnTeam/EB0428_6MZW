<template>
  <el-main class="no-padding">
    ...
    <el-table :data="tableData" v-loading="loading">
      <el-table-column label="下发类型" prop="down_type"></el-table-column>
      ...
      <el-table-column label="描述" prop="down_remark"></el-table-column>
...
export default {
  ...
  created(){
    this.$axios.get('/apis/yuancheng/delivery/')
      .then(response => {
